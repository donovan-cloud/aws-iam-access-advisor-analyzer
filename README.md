...
This repository contains an enterprise-grade Python automation script that leverages the **AWS IAM Access Advisor API** to programmatically identify and report on over-permissioned IAM identities. 
